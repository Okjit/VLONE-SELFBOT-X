...
def startprint():
    ...
    print(f'''{Fore.WHITE} 
                            ...
                            {Fore.WHITE}VloneX Selfbot v{SELFBOT.__version__} | {Fore.WHITE}Client Username:{vloneX.user.name}#{vloneX.user.discriminator}
                            {Fore.WHITE}Client ID:{vloneX.user.id} | {Fore.WHITE}Slotbot Sniper:{slotbot_sniper}
                            {Fore.WHITE}Nitro Sniper:{nitro_sniper} | {Fore.WHITE}Client Prefix:{vloneX.command_prefix}
                            {Fore.WHITE}Giveaway Sniper:{giveaway_sniper}
                            {Fore.WHITE}ezo made this aka VLONE but give vlone creds ezo#2021 <3
